...
<html>
    <head>
        <meta charset="utf-8">
        <title>@trans(Order Acceptance Note)</title>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <strong>@trans(Bill Start)</strong>: {{dformat($order->bill_started,true)}}<br/>
                                    <strong>@trans(Bill End)</strong>: {{isset($order->bill_completed) ? dformat($order->bill_completed,true) : '_________'}}
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3" align="center" style="text-align: center">
                                    <b style="text-decoration: underline">@trans(Pickup Form)</b>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td colspan="4" style="text-align: center">
                        Picked Up by:
                        <b>{{' '.isset($order->staffpicked->firstname) ? ($order->staffpicked->firstname.' '.$order->staffpicked->lastname) : ''}}</b>
                        <span style="font-size:11px">{{$order->staffpicked->email}}</span>
                        <br/>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="text-align: center">
                        @isset($order->staffpicked->firstname)
                        <img width="60%" class="img-signature" src="{{asset ('user-uploads/signatures/'.$order->pickup_signature)}}" />
                        @endisset
                        <br/>
