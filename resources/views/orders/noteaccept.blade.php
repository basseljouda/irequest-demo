                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    ...
                                    Delivered On: {{dformat($order->delivered_at)}}<br>
                                    <strong>Bill Start</strong>: {{dformat($order->bill_started,true)}}<br/>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3" align="center" style="text-align: center">
                                    <b style="text-decoration: underline">Acceptance Form</b>
                                </td>
                            </tr>
                        </table>
                    </td>
