...
<div class="row mobile-hide hide">
    <div class="col-12">
        <div class="tabbed round">
            <ul>
                <li href="#"  data-status="" class="text-info active">
                    All RMAs
                </li>
                
                <li href="#"  data-status="pending" class="text-dark">
                    Pending
                </li>
                
                <li href="#" data-status="approved" class="text-dark">
                    <i class=""></i>
                    Approved
                </li>
                <li href="#" data-status="shipped" class="text-dark">
                    <i class=""></i>
                    @trans(Shipped)
                </li>
                 <li href="#" data-status="received" class="text-dark">
                    <i class=""></i>
                    @trans(Received)
                </li>
                <li href="#" data-status="rejected" class="text-dark">
                    <i class=""></i>
                    @trans(Rejected)
                </li>
                ...
                <li href="#" data-status="completed" class="text-dark">
                    <i class=""></i>
                    @trans(Completed)
                </li>
        ...
        <div class="col-md-12">
            <div class="card" id="ticket-filters">
                <div class="card-body">
                        ...
                        <div class="col-md-3 col-sm-6 col-12">
                            <div class="form-group">
                                <select name="" id="filter_status" class="select2 form-control">
                                    <option selected value="">@lang('app.status'): @lang('app.all')</option>
                                    @foreach (config('constant.rma_orders') as $key => $value)
                                    @if ($key=='pending1')
                                    <option selected value="{{ $key }}"> {{ ucfirst($value) }} </option>
                                    @else
                    ...
                    <div class="row hide">
                        <div class="col-md-3 col-sm-6 col-12 hide">
                            <div class="form-group">
        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive m-t-40">
                    <table  id="myTable" class="table table-bordered orders-table nowrap">
                        <thead>
                            <tr>
                                <th>#</th>
...
let options = {"order": [[1, 'desc']], responsive: false, scrollX: true,
    scrollCollapse: true,
    fixedColumns: {
        left: 1,
    },
    ajax: {'url': '{!! route('part_request.index_rma_data') !!}',
        "data": function (d) {
            return $.extend({}, d, {
    ...
    columns: [
        ...
        /*{data: 'user.user_name', name: 'users.name'},*/
        {data: 'contact_name', name: 'part_rma.contact_name'},
        {data: 'status', name: 'status'},
        //{data: 'return_type', name: 'return_type',class:"capitalize"},
        //{data: 'return_reason', name: 'return_reason',class:"capitalize"},
...
$('#apply-filters').click(function () {
    ...
    if ($('#filter_status').val() != '' && $('#filter_status').val() != "{{config('constant.orders.del')}}") {
