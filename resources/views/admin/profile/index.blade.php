                ...
                <div class="card-body">
                    ...
                    <form id="editSettings" class="ajax-form">
                        ...
                        <div class="form-group" style="margin-top:30px">
                            <input checked="" class="form-check-input" type="checkbox" name="agree_sms" id="agree_sms" {{isset($order->exclude_from_report)&&$order->exclude_from_report==1?'checked':''}}>
                        <label class="form-check-label" for="agree_sms" style="color:brown">
                            <b>I agree to receive text messages from the system</b>
                        </label>                        
                    </div>
                        <hr/>
                        <div class="form-group">
