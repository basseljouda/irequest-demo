                         ...
                         <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="example">
                                    ...
                                    <input type="text" name="primary_color" class="gradient-colorpicker form-control" autocomplete="off" value="{{ $theme->primary_color }}" />
                                </div>
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <textarea name="admin_custom_css" class="my-code-area" rows="20" style="width: 100%">@if(is_null($theme->admin_custom_css))/*Enter your custom css after this line*/@else {!! $theme->admin_custom_css !!} @endif</textarea>

                            </div>

                            <div class="col-md-12 mb-4">
                                <h5 class="box-title">@lang('modules.themeSettings.frontSiteCustomCss')</h5>
                                <textarea name="front_custom_css" class="my-code-area" rows="20" style="width: 100%">@if(is_null($theme->front_custom_css))/*Enter your custom css after this line*/@else {!! $theme->front_custom_css !!} @endif</textarea>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <input type="file" id="input-file-now" name="image" accept=".png,.jpg,.jpeg" class="dropify"
                                                   data-default-file="{{ $theme->background_image_url }}"
                                            />
                                        </div>
                                    </div>
                                </div>
