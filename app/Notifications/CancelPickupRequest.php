...
class CancelPickupRequest extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Pickup Request Cancellation: #'.$this->order->order_id)
            ->greeting(__('email.hello').' ' . ucwords($notifiable->name) . '!')
            ->line('The pickup request for order #'.$this->order->order_id.' is Cancelled by: '.ucwords($this->user->name))
