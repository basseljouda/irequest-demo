...
class RequestOrderStatus extends Notification implements ShouldQueue {
    ...
    public function toMail($notifiable) {
        ...
        return (new MailMessage)
                        ->subject('Part Order #' . $this->order->getCustomID().
                                ' Status: '.ucwords($this->order->status))
                        ->greeting(__('email.hello') . ' ' . ucwords($notifiable->name) . '!')
                        ->line('Order: #' . $this->order->getCustomID() . ' Status changed to: ' .
                                ucwords($this->order->status))
    ...
    public function toNexmo($notifiable) {
        return (new NexmoMessage)
                        ->content("Part's Order #" . $this->order->getCustomID() . ' Status changed to: ' . ucwords($this->order->status))->unicode();
    }
