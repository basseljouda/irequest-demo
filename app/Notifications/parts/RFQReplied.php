...
class RFQReplied extends Notification implements ShouldQueue {
    ...
    public function toMail($notifiable) {
        ...
        return (new MailMessage)
                        ->subject('RFQ Replied: #' . $this->partRequest->id)
                        ->greeting(__('email.hello') . ' ' . ucwords($notifiable->name) . '!')
                        ->line('RFQ replied by: ' . 
                                ucwords($this->partRequest->rfqRepliedBy->name))
    ...
    public function toNexmo($notifiable) {
        return (new NexmoMessage)
                        ->content("RFQ replied by: " . ucwords($this->partRequest->rfqRepliedBy->name))->unicode();
    }
